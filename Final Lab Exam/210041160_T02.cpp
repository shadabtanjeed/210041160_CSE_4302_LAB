...
public:
    ...
    class InsuffiecientFundException
    {
    };
...
public:
    ...
    virtual void withdraw(int amount)
    {
        if (amount > bank_balance)
            throw InsuffiecientFundException();

        bank_balance -= amount;
    }

    void show_statements()
    {
    }
};
...
int main()
{
    try
    {
        ...
        sv1.get_updated_balance();
    }

    catch (Account::InvalidTransactionException)
    {
        cout << "Transaction could not be completed" << endl;
    }

    catch (Account::InsuffiecientFundException)
    {
        cout << "Insufficient Balance" << endl;
    }

    catch (Account::InvalidAccountException())
    {
        cout << "User cannot withdraw or deposit money";
    }
}